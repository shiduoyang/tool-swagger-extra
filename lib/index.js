...
function SwaggerExtra(configDirPath, controllerDirPath, options) {
    let isSwaggerOpen = options.isSwaggerOpen == null || options.isSwaggerOpen == undefined ? true : options.isSwaggerOpen,
        isAutoFixControllersOpen = options.isAutoFixControllersOpen == null || options.isAutoFixControllersOpen == undefined ? true : options.isAutoFixControllersOpen,
