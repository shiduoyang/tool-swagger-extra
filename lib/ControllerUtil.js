...
function ControllerUtil(configDirPath, controllerDirPath, postBodyGetCode, getParamsGetCode, controllerReturnCode) {
    this.configDirPath = configDirPath;
    this.controllerDirPath = controllerDirPath;
    this.postBodyGetCode = postBodyGetCode;
    this.getParamsGetCode = getParamsGetCode;
    this.controllerReturnCode = controllerReturnCode;
}
...
ControllerUtil.prototype.appendInterfaceToFile = function (apiFilePath, controllerClassName, interfaceName, method, summary, description, parameters = []) {
    ...
    if (method.toLowerCase() == 'post' || method.toLowerCase() == 'get') {
        interfaceContentI = interfaceContentI
            + `\tconst paramsBody = ${method.toLowerCase()=='post'? this.postBodyGetCode: this.getParamsGetCode },\n`;
